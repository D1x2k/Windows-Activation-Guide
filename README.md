...
- Команда скачивает ``.bat`` файла с [официальной страницы релиза](https://github.com/D1x2k/Windows-Activation-Guide/blob/main/Windows-Activation.bat). Это можно увидеть посмотрев на **ссылку в команде.**
